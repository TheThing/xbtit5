    ...
    <div align="center">
      <table width="100%" class="lista" border="0" cellspacing="5" cellpadding="5">
        <tr>
          ...
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.filename />
		  <if:MOD>
          <tag:mod_task />
          </if:MOD>
		  </td>
        ...
        <tr>
          ...
          <td class="lista" align="center" style="text-align:left;"><a href="download.php?id=<tag:torrent.info_hash />&amp;f=<tag:torrent.filename />.torrent"><tag:torrent.filename /></a></td>
        </tr>
        <tr>
          <td align="right" class="header"><tag:language.INFO_HASH /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.info_hash /></td>
        </tr>
        <tr>
          <td align="right" class="header" valign="top"><tag:language.DESCRIPTION /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.description /></td>
        </tr>
        <tr>
          <td align="right" class="header"><tag:language.CATEGORY_FULL /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.cat_name /></td>
        </tr>
        <tr>
          <td align="right" class="header"><tag:language.RATING /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.rating /></td>
        </tr>
        <tr>
          <td align="right" class="header"><tag:language.SIZE /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.size /></td>
        </tr>
        <if:DISPLAY_FILES>
        <tr>
        ...
        <div style="display:none" id="files">
          <table class="lista">
            ...
            <loop:files>
            <tr>
              <td align="center" class="lista" style="text-align:left;"><tag:files[].filename /></td>
              <td align="center" class="lista" style="text-align:left;"><tag:files[].size /></td>
            </tr>
            </loop:files>
          </table>
        </div>
        ...
        <tr>
          ...
          <td class="lista" style="text-align:left;"><tag:torrent.date /></td>
        </tr>
        <if:SHOW_UPLOADER>
        <tr>
          <td align="right" class="header"><tag:language.UPLOADER /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.uploader /></td>
        </tr>
        </if:SHOW_UPLOADER>
        <if:NOT_XBTT>
        <tr>
          <td align="right" class="header"><tag:language.SPEED /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.speed /></td>
        </tr>
        </if:NOT_XBTT>
        <tr>
          <td align="right" class="header"><tag:language.DOWNLOADED /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.downloaded /></td>
        </tr>
        <tr>
          <td align="right" class="header"><tag:language.PEERS /></td>
          <td class="lista" align="center" style="text-align:left;"><tag:torrent.seeds />, <tag:torrent.leechers /> = <tag:torrent.peers /></td>
        </tr>
        <if:EXTERNAL>
        <tr>
